...
| `goal`                 | No       | `DefeatGanon`, `FastGanon`, `Dungeons`, `Pedestal`, `TriforceHunt`, `GanonHunt`, `Completionist`            | `DefeatGanon` | [Refer to the documentation](https://alttpr.com/en/options#goal)                       |
...
| `swords`               | No       | `Vanilla`, `Assured`, `Swordless`, `Random`                                                                 | `Random`      | [Refer to the documentation](https://alttpr.com/en/options#weapons)                    |
